...
export const metadata: Metadata = {
  title: 'Xe Chuyên Dùng Tín Phát — Xe Cẩu, Xe Ép Rác, Xe Chở Rác, Xe Hút Bể Phốt',
  description:
    'Đơn vị chuyên cung cấp, phân phối và đóng mới các loại xe chuyên dùng uy tín hàng đầu: Xe cẩu, xe chở rác, xe ép rác, xe hút bể phốt chất lượng cao — Ô Tô Tín Phát.',
}
